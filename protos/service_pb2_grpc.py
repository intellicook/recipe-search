...
class RecipeSearchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetHealth = channel.unary_unary(
                '/recipesearch.RecipeSearch/GetHealth',
...
class RecipeSearchServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RecipeSearchServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'recipesearch.RecipeSearch', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('recipesearch.RecipeSearch', rpc_method_handlers)
